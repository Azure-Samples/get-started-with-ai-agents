...
# Fixed version without emojis for compatibility
...
Write-Host "[OK] Authentication & Environment variables set" -ForegroundColor Green
...
Write-Host "[OK] AI Resources variables set" -ForegroundColor Green
...
Write-Host "[OK] Infrastructure variables set" -ForegroundColor Green
...
Write-Host "[OK] Configuration flags set" -ForegroundColor Green
...
Write-Host "[OK] Agent configuration set (using gpt-5-mini)" -ForegroundColor Green
...
Write-Host "[OK] Embedding model configuration set" -ForegroundColor Green
...
Write-Host "[OK] Existing project configuration set" -ForegroundColor Green

Write-Host ""
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "SUCCESS: All GitHub Actions variables configured!" -ForegroundColor Green
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "View all variables at:" -ForegroundColor Cyan
