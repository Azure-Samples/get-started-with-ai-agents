...
@app.queue_trigger(arg_name="msg", queue_name="weather-input-queue", connection="STORAGE_CONNECTION")
@app.queue_output(arg_name="outputQueue", queue_name="weather-output-queue", connection="STORAGE_CONNECTION")
